...
// Kuhanin ang info ng Admin para sa Display (Dagdag display lang, walang binago sa logic)
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // 1. Kuhanin muna ang info ng Admin para sa description ng log
    $admin_info = $conn->query("SELECT first_name, last_name FROM users WHERE id=$id AND role='admin'")->fetch_assoc();
    $admin_full_name = $admin_info['first_name'] . " " . $admin_info['last_name'];
    ...
    if($stmt->execute()){
        ...
        $description = "Super Admin reset password of Admin: $admin_full_name";
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .error { background: #fee2e2; color: #991b1b; border: 1px solid var(--danger); }
