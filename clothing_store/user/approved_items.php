...
// Kuhanin lang ang items na APPROVED at sa user na ito lang
$result = $conn->query("SELECT * FROM items WHERE added_by = $user_id AND status = 'approved' ORDER BY id DESC");
?>
